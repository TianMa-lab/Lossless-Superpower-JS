...
| comparator | 核心功能 | fs, path | src\superpowers\comparator.js |
...
| doc_generator | 核心功能 | fs, path | src\superpowers\doc_generator.js |
...
| executor | 核心功能 | fs, path, child_process | src\superpowers\executor.js |
...
| monitoring_system | 核心功能 | fs, path, uuid | src\superpowers\monitoring_system.js |
...
| scheduler | 核心功能 | ./sync_manager, ./analyzer, ./comparator, ./doc_generator, ./executor, fs, path | src\superpowers\scheduler.js |
...
### 3.15 events 模块 (src\superpowers\events.js)
...
### 3.26 index 模块 (src\superpowers\index.js)

#### 底层实现：
- 核心功能模块

### 3.40 permanent_memory 模块 (src\superpowers\permanent_memory.js)
...
### 3.59 storage_manager 模块 (src\superpowers\storage_manager.js)
...
### 4.39 performance_optimizer 模块 (src\superpowers\performance_optimizer.js)

#### 底层实现：
- 功能模块

### 4.45 self_evolution 模块 (src\superpowers\self_evolution.js)
...
### 4.52 skill_manager 模块 (src\superpowers\skill_manager.js)
...
### 4.66 task_tracker 模块 (src\superpowers\task_tracker.js)
...
### 5.22 feishu_tools 模块 (src\superpowers\feishu_tools.js)

#### 底层实现：
- 集成模块

### 5.24 github_sync 模块 (src\superpowers\github_sync.js)
...
### 5.41 plugin_system 模块 (src\superpowers\plugin_system.js)
...
### 7.11 dag_kg_auto_iteration 数据结构
...
### 7.21 intelligent_prediction 数据结构
...
### 7.26 kg_dag_integration_enhanced 数据结构
...
### 7.27 knowledge_graph_embedding 数据结构
...
### 7.28 knowledge_graph_reasoner 数据结构
...
### 7.31 multi_dimensional_optimizer 数据结构
...
### 7.39 skill_knowledge_graph 数据结构
...
### 7.45 skill_security_scanner 数据结构
...
### 7.47 skill_version_detector 数据结构
...
### 7.58 test_result_recorder 数据结构
